...
export default function CheckEligibility() {
  ...
  const [source, setSource] = useState<"galxe" | "web" | "all">("web");
      ...
      <Card className="bg-black/40 backdrop-blur-md border border-orange-500/30 max-w-xl mx-auto p-6">
        <CardContent className="space-y-6">
          <div className="flex gap-4">
            <Button
              variant={source === "all" ? "outline" : "default"}
              className={cn(
                "",
                source !== "all" && "hover:bg-white hover:text-black"
              )}
