...
import CheckEligibility from "../features/claim/CheckEligibility";
        ...
        >
          ...
          <motion.div className="mt-12 space-y-6" variants={fadeInUp}>
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Airdrop distribution details will be announced on our official
              social channels. Join us to get the latest news!
            </p>
