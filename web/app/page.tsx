              ...
              <DialogContent className="bg-black/90 border border-orange-500/30 text-white max-w-2xl">
                ...
                <Alert className="bg-yellow-900/20 border-yellow-500/30 mb-6">
                  ...
                  <AlertDescription className="text-yellow-200">
                    ...
                    usernames from your social media accounts. When the airdrop
                    is distributed, our AI will audit whether these accounts
                    actually completed the tasks. Using different names may
                    cause issues during the claim process.
                  </AlertDescription>
                </Alert>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            >
              <Alert className="bg-yellow-900/20 border-yellow-500/30">
                ...
                <AlertDescription className="text-yellow-200">
                  <strong>Important:</strong> All airdrop claims will be
                  processed through this official website regardless of your
                  participation method. Keep your registered Ethereum address
                  safe and monitor our official channels for distribution
                  announcements.
                </AlertDescription>
              </Alert>
            </motion.div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                ...
                . Every project in our ecosystem carries a mission to deliver
                real innovation without compromising integrity.
              </p>
            </motion.div>
