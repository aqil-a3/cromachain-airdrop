...
export async function GET(req: NextRequest) {
  ...
  if (token === "8") {
    ...
    const TASK_IDS: string[] = ["11f4a316-5a69-4893-b70e-79e260c2aca3"];
    const tasks = await gettaskRewardByTaskIdBulks(TASK_IDS);
    const verifTask = await getUserTaskByTaskIdAndUserId("11f4a316-5a69-4893-b70e-79e260c2aca3", userId!);
